  ...
  return (
    <section className="min-h-screen w-full bg-primary px-2 pb-40">
      <div className="max-w-screen-lg mx-auto flex justify-center items-center h-full px-auto md:flex-row">
        <header className="flex flex-col md:justify-start h-screen pt-2 mt-40 mb-14 md:-mb-60">
      ...
      <div className="max-w-screen-md md:mx-auto mx-4 mt-20 p-6 md:p-20 border-solid border-2 border-y-cyan-50 rounded-md shadow-md shadow-white text-center">
