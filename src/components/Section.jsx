...
export const Section = () => {
  ...
  return (
    <section className="min-h-screen w-full bg-primary px-2 pb-40 flex flex-col justify-center items-center font-title">
      ...
      <div className="max-w-screen-md md:mx-auto mx-6 mt-20 p-6 md:p-20 border-solid border-2 border-y-cyan-50 rounded-md shadow-md shadow-white text-center">
        <p className="text-slate-200 font-title md:text-xl font-bold leading-6">
...
{/* <div className="flex flex-wrap max-w-xs md:max-w-4xl justify-center md:justify-center -mt-12"> */}
